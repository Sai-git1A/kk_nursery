...
export default function Privacy() {
    ...
    return (
        ...
        <div className='privacy-info-div'>
            <h3 className='privacy-subtitle'>3. How We Collect Information</h3>
            <span className='privacy-text'>We collect this information through registration and contact forms on our website.</span>
        </div>
        <div className='privacy-info-div'>
            <h3 className='privacy-subtitle'>4. Why We Collect Information</h3>
        ...
        <div className='privacy-info-div'>
            <h3 className='privacy-subtitle'>5. Data Storage and Protection</h3>
        ...
        <div className='privacy-info-div'>
            <h3 className='privacy-subtitle'>6. Third-Party Sharing</h3>
        ...
        <div className='privacy-info-div'>
            <h3 className='privacy-subtitle'>7. Access and Modification</h3>
