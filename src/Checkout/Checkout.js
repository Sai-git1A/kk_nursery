...
export default function Checkout() {
    ...
    return (
        ...
        <div className="checkout-user-details">
            ...
            <div className="user-box"><input className="user-details" type="text" value={user.name} name="name" onChange={(e) => setUser(preval => ({...preval, [e.target.name]: e.target.value, price:cart.reduce((a, b) => a + b.price * b.count, 0) + 89}))} placeholder="Name" /></div>
