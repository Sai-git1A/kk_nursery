...
return (
    ...
    <div className='branches'>
        <div className='branch'>
            <span className='branch-title'>Branch 1</span>
        ...
        <div className='branch'>
            <span className='branch-title'>Branch 2</span>
        ...
        <div className='branch'>
            <span className='branch-title'>Branch 3</span>
        ...
        <div className='branch'>
            <span className='branch-title'>Branch 4</span>
